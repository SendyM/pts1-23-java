...
public class Board implements BoardInterface{
    ...
    public Board(Floor floor, ArrayList<Points> points, List<PatternLineInterface> patternLines, List<WallLineInterface> wallLines,
                 FinalPointsCalculationInterface finalPointsCalculation, GameFinishedInterface gameFinishedInterface) {
